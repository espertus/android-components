...
class SyncedTabsStorageSuggestionProviderTest {
    private lateinit var remoteTabs: SyncedTabsFeature
    ...
    fun `matches remote tabs`() = runBlocking {
        val provider = SyncedTabsStorageSuggestionProvider(remoteTabs, mock())
        ...
        whenever(remoteTabs.getSyncedTabs()).thenReturn(mapOf(deviceTabs1, deviceTabs2))
