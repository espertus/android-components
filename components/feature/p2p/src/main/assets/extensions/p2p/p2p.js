...
class ReaderView {
  ...
  static isReaderable() {
    ...
    console.log("isProbablyReaderable is: " + isProbablyReaderable);
...
port.onMessage.addListener((message) => {
    ...
    console.log(ReaderView.isReaderable()) // JavaScript Error: "readerView.isReaderable is not a function"
